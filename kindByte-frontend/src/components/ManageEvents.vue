<template>
  ...
  .event-title { font-size: 16px; font-weight: 700; color: #0f172a; margin: 0 0 4px; }
  .event-meta { font-size: 12px; color: #64748b; margin: 0 0 8px; }
  
  .event-status { display: flex; gap: 6px; }
  .status-badge { padding: 4px 8px; border-radius: 8px; font-size: 10px; font-weight: 700; }
  .status-badge.volunteers { background: #ddd6fe; color: #7c3aed; }
  .status-badge.full { background: #fee2e2; color: #dc2626; }
  .status-badge.warning { background: #d1fae5; color: #059669; }
  ...
  .loading-box { text-align: center; padding: 40px; color: #94a3b8; font-weight: 600; }
  </style>